...
Demo: weather-app-eight-ashen-97.vercel.app
...
Stack
CamadaTecnologiaMarkupHTML5 semânticoEstiloCSS3 — glassmorphism, variáveis CSS, animaçõesLógicaVanilla JavaScript (ES2022)Busca de cidadesWeatherAPI.com — endpoint /searchClima atualOpen-Meteo — gratuito, sem API key, padrão WMOFontesGoogle Fonts — DM Serif Display + DM SansDeployVercel
Sem frameworks, sem bundlers, sem dependências de terceiros em runtime.

Como rodar localmente
bashgit clone https://github.com/seu-usuario/weather-app.git
cd weather-app
